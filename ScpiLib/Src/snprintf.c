...
static unsigned int dopr(char *buffer, unsigned int maxlen, const char *format, 
           va_list args_in);
static void fmtstr(char *buffer, unsigned int *currlen, unsigned int maxlen,
            char *value, int flags, int min, int max);
static void fmtint(char *buffer, unsigned int *currlen, unsigned int maxlen,
            long value, int base, int min, int max, int flags);
static void fmtfp(char *buffer, unsigned int *currlen, unsigned int maxlen,
...
static unsigned int dopr(char *buffer, unsigned int maxlen, const char *format, va_list args_in)
{
    char ch;
    LLONG value;
    LDOUBLE fvalue;
